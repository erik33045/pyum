...
(function ($) {
    ...
    $.widget("ui.dialog", {init: function () {
        ...
        if ($.fn.resizable) {
            uiDialog.resizable({cancel: '.ui-dialog-content', helper: options.resizeHelper, maxWidth: options.maxWidth, maxHeight: options.maxHeight, minWidth: options.minWidth, minHeight: options.minHeight, start: function () {
    ...
    $.extend($.ui.dialog, {defaults: {autoOpen: true, autoResize: true, bgiframe: false, buttons: {}, closeOnEscape: true, draggable: true, height: 200, minHeight: 100, minWidth: 150, modal: false, overlay: {}, position: 'center', resizable: true, stack: true, width: 300, zIndex: 1000}, overlay: function (dialog) {
...
(function ($) {
    ...
    $.widget("ui.slider", {plugins: {}, ui: function (e) {
        ...
        $.extend(handleclass.prototype, $.ui.mouse, {mouseStart: function (e) {
        ...
        if (/(37|38|39|40)/.test(keyCode)) {
            this.moveTo({x: /(37|39)/.test(keyCode) ? (keyCode == 37 ? '-' : '+') + '=' + this.oneStep("x") : 0, y: /(38|40)/.test(keyCode) ? (keyCode == 38 ? '-' : '+') + '=' + this.oneStep("y") : 0}, handle);
        }
...
(function ($) {
    $.widget("ui.tabs", {init: function () {
        ...
        return $.event.fix({type: type, target: this.element[0]});
    }});
...
(function ($) {
    ...
    $.extend(Datepicker.prototype, {markerClassName: 'hasDatepicker', log: function () {
        ...
        return{id: target[0].id, input: target, selectedDay: 0, selectedMonth: 0, selectedYear: 0, drawMonth: 0, drawYear: 0, inline: inline, dpDiv: (!inline ? this.dpDiv : $('<div class="ui-datepicker-inline"></div>'))};
